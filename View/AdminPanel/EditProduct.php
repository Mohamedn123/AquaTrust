            ...
            <div class="row h-50 justify-content-center align-items-center">
                <div class="col-10 col-md-8 col-lg-6">
                    ...
                    <form action="../../Controller/ProductController.php" method="post" class="form-example" >
                        <h1 class="text-center">Edit <?php echo $Product->getName(); ?></h1>

                        <div class="form-group">
                            <label for="Title">Product Name</label>
                            <input type="text" class="form-control username" id="Title" value="<?php echo $Product->getName(); ?>" placeholder="Name..." name="name">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Product Description</label>
                            <textarea class="form-control" id="Description" name="description" rows="10" maxlength="10000"><?php echo $Product->getDescription(); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control"  name="type" id="exampleFormControlSelect2">
                                <?php if ($Product->getType() == 1){
                                    echo '<option selected="selected" value="1">Cooling</option>';
                                }else{
                                    echo '<option value="1">Cooling</option>';
                                }
                                if ($Product->getType()==2){

                                    echo '<option selected="selected" value="2">Boilers</option>';
                                }else{
                                    echo '<option value="2">Boilers</option>';
                                }
                                if ($Product->getType()==3){

                                    echo '<option selected="selected" value="3">Speciality Chemicals</option>';
                                }else{
                                    echo '<option value="3">Speciality Chemicals</option>';
                                }
                                ?>
                        ...
                        <input type="number" name="ID" hidden value="<?php echo $Product->getID(); ?>">
                        <button type="submit" name="EditProduct" class="btn btn-primary btn-customized">Post</button>
                        <!-- End input fields -->
                    </form>
                    <!-- Form end -->
                </div>
