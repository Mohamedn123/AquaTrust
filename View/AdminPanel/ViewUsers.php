...
<html>
    ...
    <ul class="nav nav-tabs nav-fill">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <a href="CreateUser.php"><button class="btn-primary">Add New User</button></a>
                    <div class="mt-4"></div>
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <th scope="row"><?php echo $Users[$x]->getID(); ?></th>
                                        <td><?php echo $Users[$x]->getUsername(); ?></td>
                                        <td><a href="../../Controller/UserController.php?delete=<?php echo $Users[$x]->getID(); ?>"><img src="../../Images/MiniLogos/delete.png"></a> </td>
                                    </tr>
