...
<html>
    ...
    <ul class="nav nav-tabs nav-fill">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <a href="CreateNews.php"><button class="btn-primary">Add New News</button></a>
                    <div class="mt-4"></div>
                    <table class="table table-bordered table-hover">
                        ...
                        if ($News != null){
                            ...
                            for ($x=0;$x<sizeof($News);$x++){
                                $TempDescription = "";
                                $Description = $News[$x]->getDescription();
                                ...
                                ?>
                            <tr>
                                <th scope="row"><?php echo $News[$x]->getID(); ?></th>
                                <td><?php echo $News[$x]->getTitle(); ?></td>
                                <td><?php echo $TempDescription;?></td>
                                <td><a href="EditNews.php?ID=<?php echo $News[$x]->getID(); ?>"><img src="../../Images/MiniLogos/edit.png"> </a>
                                    <a href="../../Controller/NewsController.php?delete=<?php echo $News[$x]->getID(); ?>"><img src="../../Images/MiniLogos/delete.png"></a> </td>
                            </tr>
