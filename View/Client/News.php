                ...
                <div class="row">
                    ...
                    if ($News != null) {
                        for ($x = 0; $x < sizeof($News); $x++) {
                            ...
                            ?>
                            <a href="ViewNews.php?ID=<?php echo $News[$x]->getID(); ?>" style="text-decoration: none;">
                                <div class="card mb-3" style="background:rgba(255,255,255,0.5);">
                                    <img src=<?php echo $News[$x]->getImagePath(); ?> class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title text-dark"><?php echo $News[$x]->getTitle(); ?></h5>
                                        <p class="card-text text-dark"><?php echo $TempDescription; ?></p>
                                    </div>
                                </div>
                            </a>
                            <?php
