...
$Products = $ProductController->getProductByType(1);
?>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Services and Products</a>
            <ul>
              <li class="active"><a href="CoolingProducts.php">Cooling</a></li>
...
<footer id="footer" class="pt-5 mt-5 bx-align-bottom">
    <div class="container">
