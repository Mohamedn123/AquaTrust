  ...
  <main>
    ...
    <section class="breadcrumbs">
      ...
      <div class="d-flex justify-content-between align-items-center">
          <h2 class="pt-3"><?php echo $News->getTitle(); ?></h2>
        </div>
      </div>
                    ...
                    if ($News != null) {
                            ?>
                                <div class="card mb-3" style="background:rgba(255,255,255,0.5);">
                                    <img src=<?php echo $News->getImagePath(); ?> class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <pre class="card-text text-dark font-weight-normal text-break" style="font-family:Helvetica; white-space:pre-wrap;"><?php echo $News->getDescription(); ?></pre>
                                    </div>
                                </div>
                            <?php
                        }
